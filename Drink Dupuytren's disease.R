###Drinks per week Dupuytren's disease
getwd()
setwd('E:/RWork')
...
dat$samplesize.exposure <- 941280	  
...
#Leave-one-out(Figure 1)
single <- mr_leaveoneout(dat)
write.csv( single, file="single.csv")
mr_leaveoneout_plot( single)

#Scatter plot(Supplementary Figure 3. Scatter plot for drinks per week.)
mr_scatter_plot(res,dat)

#Funnel plot(Supplementary Figure 9. Funnel plot for drinks per week.)
